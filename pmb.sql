...
--
-- Host: localhost:3306
-- Waktu pembuatan: 18 Des 2023 pada 01.19
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
INSERT INTO `kabupatens` (`id`, `province_id`, `name`) VALUES
...
(7, '2023_12_17_224825_create_provinsis_table', 2),
(9, '2023_12_17_224826_create_pendaftarans_table', 3);
...
CREATE TABLE `pendaftarans` (
  ...
  `negara_wna` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tanggal_lahir` date NOT NULL,
  `tempat_lahir` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kabupaten_lahir_id` bigint UNSIGNED NOT NULL,
  `provinsi_lahir_id` bigint UNSIGNED NOT NULL,
  `negara_lahir` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `jenis_kelamin` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status_menikah` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `pendaftarans` (`id`, `user_id`, `nama_lengkap`, `foto_ktp`, `alamat_ktp`, `alamat_tinggal`, `kecamatan`, `kabupaten_id`, `provinsi_id`, `no_telepon`, `no_hp`, `email`, `kewarganegaraan`, `negara_wna`, `tanggal_lahir`, `tempat_lahir`, `kabupaten_lahir_id`, `provinsi_lahir_id`, `negara_lahir`, `jenis_kelamin`, `status_menikah`, `agama`, `created_at`, `updated_at`) VALUES
(1, 6, 'Qui dolores commodi ', NULL, 'Officia nulla mollit', 'Aut quos maiores omn', '1992-03-04', 5171, 31, '31', '71', 'kyfobohih@mailinator.com', 'wni_keturunan', '', '2008-07-03', 'Voluptas rerum dolor', 5305, 33, 'Ipsum atque reprehe', 'P', 'lainnya', 'kristen', '2023-12-17 17:47:18', '2023-12-17 17:47:18');
...
(2, 'Admin', 'admin', 'admin@gmail.com', '2023-12-16 22:20:43', '$2y$12$qZVlNghlTpuljfcJmGpf0eB6EQUzd/k.7J7NWOcPX5UBjbd9Kx3fe', 1, 'PWxjgNW3OiC0jZDMjCWl9FiCH3FD0McxgFDnAEHzUCjIXHMhHpSdR78T5lkA', '2023-12-16 22:20:44', '2023-12-16 22:20:44'),
...
(6, 'Kiona Bonner', 'goqozatoge', 'hetosax@mailinator.com', NULL, '$2y$12$rLwxlR3iVJClJBIxPmizb.r7XjaIlJWihppf140uBYmrX6GXEGzvW', 0, NULL, '2023-12-17 15:44:16', '2023-12-17 15:44:16');
...
ALTER TABLE `kabupatens`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kabupatens_province_id_index` (`province_id`);
...
--
ALTER TABLE `kabupatens`
  ADD CONSTRAINT `kabupatens_province_id_foreign` FOREIGN KEY (`province_id`) REFERENCES `provinsis` (`id`);
